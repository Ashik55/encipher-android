...
//fun Context.getResDrawable(@DrawableRes drawableRes: Int, @FloatRange(from = 0.0, to = 1.0) alpha: Float = 1f): Drawable? {
//    return ContextCompat.getDrawable(this, drawableRes)?.mutate()?.apply {
